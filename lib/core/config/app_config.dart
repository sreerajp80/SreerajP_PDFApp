...
class LocalizedText {
  ...
  /// [languageCode] is the active app language: 'en', 'ml', 'sa'.
  ...
  /// Accepts a JSON string or a {"en": ..., "ml": ...} map.
...
/// Changing About content is a config edit, not a code change (guideline.md §1).
class AppConfig {
  ...
  static const AppConfig fallback = AppConfig(
    appName: LocalizedText.plain('SreerajP PDF App'),
    description: LocalizedText.plain(
      'An offline Android app for everything PDF.',
    ),
    version: '0.0.0',
    build: '0',
  );
