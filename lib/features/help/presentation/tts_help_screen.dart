...
/// Help topic screen detailing Read Aloud (TTS) and Malayalam voice configuration.
class TtsHelpScreen extends StatelessWidget {
  const TtsHelpScreen({super.key});
        ...
        child: ListView(
          ...
          children: [
            ...
            FilledButton.icon(
              ...
              icon: const Icon(Icons.settings_voice_outlined, size: 20),
              label: Text(
                l10n.helpOpenTtsSettings,
                style: const TextStyle(
                  fontWeight: FontWeight.w700,
                  fontSize: 15,
                ),
              ),
              onPressed: () => context.pushNamed(AppRoute.ttsSettings.name),
            ),
          ],
        ),
      ),
